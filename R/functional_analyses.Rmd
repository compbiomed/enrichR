...
# unlink(fileNameOut)
wb <- openxlsx::loadWorkbook(fileName) # openxlsx::createWorkbook(fileNameOut)
```
...
- Up- and downregulated genes are tested for enrichment separately. Only genes at FDR < `r p.adj.cutoff` are analyzed.
